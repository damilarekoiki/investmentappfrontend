    ...
    <v-card>
        ...
        >
            ...
            <template v-slot:[`item.activation_status`]="{ item }">
                <div class="tw-bg-opacity-10 tw-p-2 tw-rounded-sm tw-text-xs tw-font-bold tw-max-w-md tw-text-center"
                    :class="[
                        item.activation_status == 1 ? 'tw-bg-blue-300' : 'tw-bg-red-300',
                        item.activation_status == 1 ? 'tw-text-blue-800' : 'tw-text-red-800'
                    ]"
                >
                ...
                users: [
                    {
                        ...
                        gender: 'Male',
                        activation_status: '0',
                        img_url: 'https://static.standard.co.uk/2021/04/23/14/newFile-1.jpg?width=968',
